...
<h2 className="mb-4 text-center text-2xl font-bold text-gray-800 md:mb-6 lg:text-3xl">SALAS INTERACTIVAS</h2>
...
<a href="/Ingenius" className="group relative flex h-80 items-end overflow-hidden rounded-lg bg-gray-100 p-4 shadow-lg">
...
<div className="relative flex flex-col">
  ...
  <span className="text-lg font-semibold text-white lg:text-xl">INGENIUS</span>
</div>
</a>

<a href="/Sensoria" className="group relative flex h-80 items-end overflow-hidden rounded-lg bg-gray-100 p-4 shadow-lg">
...
<div className="relative flex flex-col">
  ...
  <span className="text-lg font-semibold text-white lg:text-xl">SENSORIA</span>
</div>
</a>
</div>
</div>
