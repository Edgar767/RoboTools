...
const Robotica = () => {
    const posts = [
    {
        ...
        date: "",
        href: "/legoeducation" // Ruta a la que se redirigirá al presionar esta entrada
    },
    {
        ...
        date: "",
        href: "/microbit" // Ruta a la que se redirigirá al presionar esta entrada
    },
    {
        title: "MOJO RT",
            ...
            <section className="py-32">
                <div className="max-w-screen-xl mx-auto px-4 md:px-8">
                    <div className="space-y-5 sm:text-center sm:max-w-md sm:mx-auto">
                        <h1 className="text-gray-800 text-3xl font-extrabold sm:text-4xl">ROBOTICA</h1>
                    </div>
