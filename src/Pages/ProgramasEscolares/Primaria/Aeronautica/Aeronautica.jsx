...
const Aeronautica = () => {
  ...
  <div className="mx-auto max-w-screen-2xl px-4 md:px-8">
    ...
    <div className="mb-10 md:mb-16">
      <h2 className="mb-4 text-center text-2xl font-bold text-gray-800 md:mb-6 lg:text-3xl">Aeronautica</h2>
    ...
    <div className="grid gap-6 sm:grid-cols-2">
      ...
      <a href="/Cohetes" className="group relative flex h-80 items-end overflow-hidden rounded-lg bg-gray-100 p-4 shadow-lg">
      ...
      <a href="/Drones" className="group relative flex h-80 items-end overflow-hidden rounded-lg bg-gray-100 p-4 shadow-lg">
