...
const postsData = [
    {
        ...
        date: "",
        href: "/Robotica" // Ruta a la que se redirigirá al presionar esta entrada
    },
    {
        title: "AERONAUTICA",
        desc: "",
        ...
        date: "",
        href: "/Aeronautica" // Ruta a la que se redirigirá al presionar esta entrada
    },
    {
        ...
        date: "",
        href: "/RealidadVirtual" // Ruta a la que se redirigirá al presionar esta entrada
    },
    {
        title: "BREAKOUT EDU",
        desc: "",
        ...
        date: "",
        href: "/Breakout" // Ruta a la que se redirigirá al presionar esta entrada
}
];
...
const Primaria = () => {
    ...
    return (
      ...
      <div className="flex justify-center space-x-4 mt-8 mb-4">
        ...
        <h4 className="title color-variation-1 mt-20 mb-10 text-center text-4xl font-extrabold">Primaria</h4>
