            ...
            <div className="bg-white py-6 sm:py-8 lg:py-12">
                <div className="mx-auto max-w-screen-2xl px-4 md:px-8">
                    ...
                    <div className="grid grid-cols-3 gap-6">
                        <a href="#" className="group relative flex h-80 items-end overflow-hidden rounded-lg bg-gray-100 p-4 shadow-lg">
                            ...
                            <div className="relative flex flex-col">
                                ...
                                <span className="text-lg font-semibold text-white lg:text-xl">LITTLE BEE WING</span>
                            </div>
                        </a>
                        <a href="#" className="group relative flex h-80 items-end overflow-hidden rounded-lg bg-gray-100 p-4 shadow-lg">
                            <img src="https://via.placeholder.com/1800x1000" loading="lazy" alt="Photo by Fakurian Design" className="absolute inset-0 h-full w-full object-cover object-center transition duration-200 group-hover:scale-110" />
                            ...
                            <div className="relative flex flex-col">
                                ...
                                <span className="text-lg font-semibold text-white lg:text-xl">LITTLE BEE WING FM</span>
                            </div>
                        </a>
                        <a href="#" className="group relative flex h-80 items-end overflow-hidden rounded-lg bg-gray-100 p-4 shadow-lg">
                            <img src="https://via.placeholder.com/1800x1000" loading="lazy" alt="Photo by Fakurian Design" className="absolute inset-0 h-full w-full object-cover object-center transition duration-200 group-hover:scale-110" />
                            ...
                            <div className="relative flex flex-col">
                                <span className="text-gray-300">Secundaria</span>
                                <span className="text-lg font-semibold text-white lg:text-xl">GHOST II</span>
                            </div>
                        </a>
                    </div>
                </div>
