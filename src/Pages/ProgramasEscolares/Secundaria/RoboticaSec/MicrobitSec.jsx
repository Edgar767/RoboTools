    ...
    <div className="grid gap-6 sm:grid-cols-2">
      ...
      <a href="#" className="group relative flex h-80 items-end overflow-hidden rounded-lg bg-gray-100 p-4 shadow-lg">
        ...
        <div className="relative flex flex-col">
          ...
          <span className="text-lg font-semibold text-white lg:text-xl">MICROBIT V2.0</span>
        </div>
      </a>
      ...
      <a href="#" className="group relative flex h-80 items-end overflow-hidden rounded-lg bg-gray-100 p-4 shadow-lg">
        ...
        <div className="relative flex flex-col">
          ...
          <span className="text-lg font-semibold text-white lg:text-xl">C.T. STARTER KIT</span>
        </div>
      </a>
    </div>
  </div>
