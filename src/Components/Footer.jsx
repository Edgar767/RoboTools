...
return(
  <div className="relative z-10">
    <footer className="px-4 divide-y dark:bg-gray-100 dark:text-gray-800">
			...
			<div className="grid grid-cols-2 text-sm gap-x-3 gap-y-8 lg:w-2/3 sm:grid-cols-4">
				...
				<div className="space-y-3">
					...
					<div className="flex justify-start space-x-3">
						<a rel="noopener noreferrer" href="https://www.facebook.com/Robotools" title="Facebook" className="flex items-center p-1">
						...
						<a rel="noopener noreferrer" href="https://www.instagram.com/robotools.rt/" title="Instagram" className="flex items-center p-1">
		...
		<div className="py-6 text-sm text-center dark:text-gray-600">© 2024 Robotools Co. Todos los Derechos Reservados.</div>
	</footer>
  </div>
    );
};
